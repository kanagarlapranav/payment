...
def preprocess_image_for_ocr(image_path: str) -> str:
    ...
    # Save processed image temporarily (or overwrite depending on need)
    # We will save it with a _processed suffix
    processed_path = image_path.replace('.jpg', '_processed.jpg').replace('.png', '_processed.png')
    
    # If the original path didn't have .jpg or .png, just append
